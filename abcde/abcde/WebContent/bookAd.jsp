      ...
      <div class="content_bg">
       ...
       <tr>
       		...
       		<td width="271"> 
					 ...
					 <input type = "radio" name = "adtype" value = "Classified Text" checked="checked"/> Classified Text Ad <br/><br/>
					 <input type = "radio" name = "adtype" value = "Classified Display"/> Classified Display Ad <br/>
       		</td>
       		</tr>
       		<tr>
       			<td height="46">

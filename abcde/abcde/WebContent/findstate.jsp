...
<%
	...
	if (request.getParameter("country") != null) {
		...
		try {
			String sql2 = "select state_id,state_name from state_info where country_id="
					+ id + " order by state_name";
...
<%
	try {
		if (request.getParameter("state") != null) {
			...
			String sql = "select city_id,city_name from city_info where state_id="
					+ state;
